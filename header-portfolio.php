...
<head>
    ...
    <title>BR TRUSTY株式会社｜マンション経営</title>
    <meta name="description" content="東京都・千葉県・埼玉県・神奈川県のマンション経営、賃貸管理、不動産買取・仲介・販売・はBRトラスティーにお任せください。マンション経営につきましてお問い合わせは03-5790-9700まで。">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown submenu">
                        <a class="nav-link dropdown-toggle" href="page-service" id="navbarDropdown" role="button"
                    ...
                    <li class="nav-item active"><a class="nav-link" href="page-portfolio">マンション経営</a></li>
                    <!-- <li class="nav-item dropdown submenu">
