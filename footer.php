...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved by BR TRUSTY
       ...
       <!--================End Footer Area =================-->
        ...
        <script src="<?php echo get_template_directory_uri(); ?>/vendors/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
        <!-- Extra plugin css -->
        <script src="<?php echo get_template_directory_uri(); ?>/vendors/counterup/jquery.waypoints.min.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/vendors/counterup/jquery.counterup.min.js"></script> 
        <script src="<?php echo get_template_directory_uri(); ?>/vendors/counterup/apear.js"></script>
        <script src="<?php echo get_template_directory_uri(); ?>/vendors/counterup/apear.js"></script>
