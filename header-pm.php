...
<html lang="ja">
    <head>
        ...
        <title>BR TRUSTY株式会社｜賃貸管理</title>
        <meta name="description" content="東京都・千葉県・埼玉県・神奈川県のマンション経営、賃貸管理、不動産買取・仲介・販売・はBRトラスティーにお任せください。賃貸管理につきましてお問い合わせは03-5790-9700まで。">
        ...
        <header class="main_menu_area">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item nav-line"><a class="nav-link" href="<?php echo home_url( '/' );?>">Home</a></li>
                        <li class="nav-item nav-line"><a class="nav-link" href="page-aboutus">会社概要</a></li>

                        <li class="nav-item dropdown submenu">
                            <a class="nav-link dropdown-toggle active" href="page-service" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            事業内容
                            </a>
                        ...
                        <li class="nav-item nav-line"><a class="nav-link" href="page-portfolio">マンション経営</a></li>
                        <!-- <li class="nav-item dropdown submenu">
