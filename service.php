            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item nav-line"><a class="nav-link" href="about-us.php">会社概要</a></li>

                        <li class="nav-item dropdown submenu">
                            <a class="nav-link dropdown-toggle active" href="service.php" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            事業内容
                            </a>
                        ...
                        <li class="nav-item nav-line"><a class="nav-link" href="portfolio.php">マンション経営</a></li>
                        <!-- <li class="nav-item dropdown submenu">
